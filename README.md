...
Устанавливается как обычное приложение, ссылка для скачивания -> [Docker Desktop](https://www.docker.com/).
### 2.2.2. Установка `git`
`git` не входит в стандартную поставку `Windows`, поэтому его нужно установить отдельно, [Git for Windows](https://git-scm.com/download/win). Установка стандартная, с параметрами по умолчанию.

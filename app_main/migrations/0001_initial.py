# Generated by Django 4.1.3 on 2022-11-14 14:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Department',
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('ebf9600c-f51c-44fc-80ac-484e94ce33bf'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД подразделения')),
        ...
        migrations.CreateModel(
            name='Document',
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('f586903d-3519-4748-bc3b-b6f85aa33b19'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД документа')),
        ...
        migrations.CreateModel(
            name='Ware',
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('2b5557b1-aec6-4469-8c75-d5e6144b54da'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД товара')),
        ...
        migrations.CreateModel(
            name='StatusFlow',
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('bb2f79fe-c034-468c-91c5-85f1f78e2d39'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД записи')),
        ...
        migrations.CreateModel(
            name='DocumentWare',
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('497101a2-def7-47f8-b994-8264a47fe670'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД товара документа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('guid', models.CharField(db_column='guid', default=uuid.UUID('51fb2661-a7a2-48ab-8646-396b1c62572e'), editable=False, max_length=64, primary_key=True, serialize=False, verbose_name='ИД записи')),

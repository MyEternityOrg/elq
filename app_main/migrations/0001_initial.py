    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date_time', models.DateTimeField(auto_now_add=True, db_column='dts', verbose_name='Дата записи')),
                ('current_status_guid', models.ForeignKey(db_column='current_status_guid', on_delete=django.db.models.deletion.CASCADE, related_name='current_status', to='app_main.status', verbose_name='Текущий статус')),
                ('next_status_guid', models.ForeignKey(db_column='next_status_guid', on_delete=django.db.models.deletion.CASCADE, related_name='next_status', to='app_main.status', verbose_name='Следующий статус')),
            ],
            options={

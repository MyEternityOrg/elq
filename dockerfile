...
EXPOSE 8000
EXPOSE 631
CMD cd elq && git pull origin master && service cups restart && python3 manage.py migrate && python3 manage.py maintenance && python3 manage.py runserver 0.0.0.0:8000